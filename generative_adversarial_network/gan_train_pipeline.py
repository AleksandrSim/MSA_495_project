...
if __name__ == '__main__':
    ...
    generate_dir_if_not_exists(user_path + gan_output_img_path)
    ...
    dataloader = DataLoader(dataset, num_workers=0, batch_size=100, shuffle=True)
    ...
    for epoch in range(opt.n_epochs):
        ...
        for i, (imgs, _) in enumerate(dataloader):
            ...
            if batches_done % opt.sample_interval == 0:
                save_image(gen_imgs.data[:25], user_path + gan_output_img_path + "%d.png" % batches_done, nrow=5,
                           normalize=True)
